...
export const NAV: NavItem[] = [
  ...
  { to: "/control-consistencia", label: "Control de consistencia", icon: ScanLine, permiso: PERMISOS.IMPORTAR_EJECUTAR, grupo: "Datos" },
  { to: "/plan-cuentas", label: "Plan de cuentas", icon: ListTree, permiso: PERMISOS.IMPORTAR_EJECUTAR, grupo: "Datos" },
